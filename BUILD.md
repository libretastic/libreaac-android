...
The following builds the complete unsigned LibreAAC 0.1.13 APK from a clean
...
test "$(git -C libreaac-android describe --tags --exact-match)" = "v0.1.13"
...
For the latest development revision, omit `--branch v0.1.13` and the exact-tag
...
glab release list
glab release view
glab release view v0.1.13
glab release download v0.1.13 -n "libreaac-v0.1.13.*"
glab release upload v0.1.13 ./additional-file
```
